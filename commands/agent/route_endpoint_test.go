...
func TestRoutePutMissingResource(t *testing.T) {
	...
	testPayload := `
	{"Name":"test-route","URIRoot":"/hello","Backends":["demo-backend"],"Plugins":null,"MultiBackendPlugin":"","MsgProps":""}
	`
...
func TestRouteGet(t *testing.T) {
	...
	expected := `{"Name":"test-route","URIRoot":"/hello","Backends":["demo-backend"],"Plugins":null,"MultiBackendPlugin":"","MsgProps":""}`
