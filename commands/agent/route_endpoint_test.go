...
func TestRoutePutMissingResource(t *testing.T) {
	...
	testPayload := `
	{"Name":"test-route","URIRoot":"/hello","Backend":"demo-backend","Filters":null,"MsgProps":""}
	`
...
func TestRouteGet(t *testing.T) {
	...
	expected := `{"Name":"test-route","URIRoot":"/hello","Backend":"demo-backend","Filters":null,"MsgProps":""}`
